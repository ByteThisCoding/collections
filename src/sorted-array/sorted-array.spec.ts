...
describe("SortedArray", () => {
    it("should add numbers to the list and preserve sorting", () => {
        ...
        const ar = new SortedArray<number>(SortedArray.compareNumbers);
    ...
    it("should add strings to the list and preserve sorting", () => {
        ...
        const ar = new SortedArray<string>(SortedArray.compareStrings);
        ar.addMany(testItems);
    ...
    it("should add Dates to the list and preserve sorting", () => {
        ...
        const testItemsSorted = [...testItems].sort((a, b) => +a - +b);
        const ar = new SortedArray<Date>(SortedArray.compareDates);
        ar.addMany(testItems);
    ...
    it("should add custom comparable to the list and preserve sorting", () => {
        ...
        const ar = new SortedArray<TestItem>(
            SortedArray.compareFromComparable,
            testItems
        );
    ...
    it("should check if string sorted array contains certain string", () => {
        ...
        const sortedAr = new SortedArray(SortedArray.compareStrings, testItems);
    ...
    it("should get an item based on ComparableType interface", () => {
        ...
        const sortedAr = new SortedArray<iTestItemComparable, iTestItem>(
            SortedArray.compareFromProperty(
                "value",
